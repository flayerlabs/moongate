...
contract DeployBelow is Script {
    ...
    function run() external {
        ...
        InfernalRiftBelow below = new InfernalRiftBelow(_RELAYER_ADDRESS, _L2_CROSS_DOMAIN_MESSENGER, _INFERNAL_RIFT_ABOVE);

        ERC1155Bridgable erc1155Bridgable = new ERC1155Bridgable(address(below));
        ERC721Bridgable erc721Bridgable = new ERC721Bridgable('', '', address(below));
